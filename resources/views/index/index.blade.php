    ...
    <div class="hot-wrapper">
        <ul class="clearfix">
            ...
            <li style="border-right:1px solid #e4e4e4; ">
                <a href="/content/?goods_id={{$val->goods_id}}" class="g-pic">
                    <p class="title">{{$val->goods_name}}</p>
                    <p class="subtitle">{{$val->goods_desc}}</p>
                    <img src="{{URL::asset('uploads/'.$val->goods_img)}}" alt="">
                </a>
            </li>
            @endforeach
        </ul>
            ...
            ,done: function(page, next){ //执行下一页的回调
               ...
               $.ajax({
                   ...
                   ,success:function(msg){
                       ...
                       next(msg.info,page < msg.page); //假设总页数为 10
                   }
               })
            }
        });
