...
<div class="m-block-header" id="div-header">
    ...
    <a href="" class="m-index-icon" id="formDemo">保存</a>
</div>
<div class=""></div>
...
<form class="layui-form" action="">
    <div class="addrcon">
        <ul>
            <li><em>收货人</em><input type="text" id="name" placeholder="请填写真实姓名"></li>
            <li><em>手机号码</em><input type="number" id="num" placeholder="请输入手机号"></li>
