...
<div>
            ...
            <li>
                <a href="/detail/?goods_id={{$v->goods_id}}" class="g-pic">
                    ...
                    <dl>
                        ...
                        <dd><em class="num">1</em>人次/￥<em class="price">{{$v->goods_price}}</em></dd>
    ...
    {{--<ul>--}}
            {{--<li class="clearfix">--}}
                {{--<span class="fl">{{$addressInfo->username}}</span>--}}
                {{--<span class="fr">{{$addressInfo->tel}}</span>--}}
            {{--</li>--}}
            {{--<li>--}}
                {{--<p>{{$addressInfo->address_name}}</p>--}}
            {{--</li>--}}
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            for(var i = 0;i<$('.g-pay-lst li').length;i++){
                ...
                total +=parseInt($('.g-pay-lst li').eq(i).find('dd em.num').text())*parseInt($('.g-pay-lst li').eq(i).find('dd em.price').text());
            ...
            $.ajax({
                ...
                ,success:function(msg){
                    if(msg.status==1){
                        ...
                        layer.msg(msg.msg);
                        window.location.href="/payaddress";
                    }
                }
            })
            // layer.open({
